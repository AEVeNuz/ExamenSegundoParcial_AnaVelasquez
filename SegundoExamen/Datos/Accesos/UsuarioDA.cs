...
namespace Datos.Accesos
{
    ...
    {
        readonly string cadena = "Server=localhost; Port=3306; Database=Programacion; Uid=root; Pwd=Metiche;";
        ...
        public bool InsertarUsuario(Usuario usuario)
        {
            ...
            try
            {
                string sql = "INSERT INTO usuarios VALUES (@Codigo, @Nombre, @Rol, @Clave, @EstaActivo);";
                conn = new MySqlConnection(cadena);
                conn.Open();
